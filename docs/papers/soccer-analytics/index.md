...
(5) 一个<span class="term">Python包</span><sup class="ref">[[1]](#note-1)</sup>，它(a)将现有事件流数据转换为我们的语言，(b)实现我们的框架，以及(c)构建一个估计进球和失球概率的模型。

> <a id="note-1"></a><sup class="ref">1</sup> https://github.com/ML-KULeuven/socceraction
